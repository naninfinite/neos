...
const outputDir = path.join(root, 'docs', 'timeline', 'assets', '03-site-shell-01');
const bootPath = path.join(outputDir, 'site-shell-boot.png');
const homePath = path.join(outputDir, 'site-shell-home.png');
...
try {
  ...
  // Capture early entry state first (overlay may dismiss quickly).
