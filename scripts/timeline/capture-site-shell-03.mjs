...
const outputDir = path.join(root, 'docs', 'timeline', 'assets', '06-site-shell-03');
const outputPath = path.join(outputDir, 'site-shell-03-nav-warm-neutral.png');
...
try {
  ...
  await page.waitForSelector('[aria-label="Site navigation"]', { timeout: 4_000 });
