...
const outputDir = path.join(root, 'docs', 'timeline', 'assets', '05-site-shell-02-hard-reset');
const outputPath = path.join(outputDir, 'site-shell-02-hard-reset-blank-shell.png');
